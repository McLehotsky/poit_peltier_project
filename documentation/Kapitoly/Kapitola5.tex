...
\path{control_mode}. Prvé tri módy predstavujú regulačné režimy podľa zadania, ale taktiež sme pridali aj bonusový 
štvrtý mód, ktorý manuálne riadi pumpu aj Peltierov článok.
...
identifikácie a testovania reálnej tepelnej sústavy. Manuálny režim je využiteľný najmä pri 
